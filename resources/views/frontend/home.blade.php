 ...
 <section>
    ...
    <div class="custom-slider-item">
        <img src="https://html.rometheme.pro/kids/images/homeslide2.jpg" alt="">

        <div class="slider-content">
            <div>
                <h1 class="fw-bolder text-light py-5">Best Kindergerden at Califonia</h1>
                <a href="/">
                    Learn More
                </a>
            </div>
    ...
    <!-- hero bottom box  -->
    <div class="hero-bottom-box text-light text-center row justify-content-center align-content-center ">
        <div class="p-4 hero-bottom-single-box rounded-3 col-3 pb-5">
 ...
 <!----------------------------------- welcome start here-------------------------------  -->
 <section class="d-flex container-lg py-5 m-auto align-content-center  justify-content-center">
    <div class="w-50 p-4">
        <img class="w-100" src="https://html.rometheme.pro/kids/images/homeslide2.jpg" alt="">
    </div>

    <div class="w-50 p-4 py-0 welcome-content">
...
<section class="position-relative analize">
    ...
    <div class="row m-auto justify-content-center py-5">
 ...
 <section class="text-center program py-5">
    ...
    <div class="row justify-content-center py-5">
        ...
        <div class="program-single-box col-3">
            <img class="w-100" src="https://html.rometheme.pro/kids/images/classes-1.jpg" alt="">
            ...
            <div class="d-flex align-content-center justify-content-center">
                <p class="p-3 h5 w-50 text-light bg-danger">Age 2-5 years</p>
                <p class="p-3 h5 w-50 text-light bg-info">Age 2-5 years</p>
            </div>
        </div>
